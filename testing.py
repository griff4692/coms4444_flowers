...
def run_program(days, j, iterNumber, configPath):
    runString =f"python3.9 main.py --d {days} --config_path {configPath} -p_from_config -remove_round_logging -save_results --run_id run-{days}-{j}-{iterNumber}"
